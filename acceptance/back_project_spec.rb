...
feature "Back project" do
  ...
  scenario "As a user without credits, I want to back a project by clicking on the reward on the back project page, and pay using Dineromail" do
    ::Configuration.create!(name: "dineromail_merchant", value: "0552624")
    ::Configuration.create!(name: "dineromail_country_id", value: "3")
    ...
    find(".choose_payment .dineromail a").click

    current_url.should match(/dineromail\.com/)
    backer.reload
    backer.payment_method.should == "Dineromail"
